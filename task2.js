...
function checkForm() {
    ...
    document.getElementById("1.2reiss").style.display = "none";
    document.getElementById("1.1pic").style.display = "none";
    document.getElementById("1.3sig").style.display = "none";
    ...
    else if (!fileNumcheck.match(/^[A-Z0-9]*$/)) {
    ...
    if (srPiccheck.value == "") {
        document.getElementById("1.1pic").style.display = "inline";
    ...
    if (srSigcheck.value == "") {
        document.getElementById("1.3sig").style.display = "inline";
